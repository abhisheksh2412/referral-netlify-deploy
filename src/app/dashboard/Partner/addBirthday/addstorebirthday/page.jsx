...
const options = [{ label: "Store 1", value: "Store 1" }, { label: "Store 2", value: "Store 2" }];
            ...
            <div className="p-8 mobile:p-2">
                ...
                <Container>
                    <div className="p-12 mobile:p-6 tab:p-4 new-shadow  bg-white lg:w-3/5 mobile:w-full tab:w-9/12 sm:w-8/12 	mx-auto rounded-lg">
                        ...
                        <h3 className="text-left text-2xl leading-tight mb-6 font-semibold text-black">Add Store Birthday</h3>
                        <form>
                            ...
                            <div className="mt-5 w-full">
                                ...
                                <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Please Write Message..."></textarea>
                            </div>


                            <div className="mt-6 w-full">
                                <p className="text-base font-semibold mb-2">Upload Birthday Image</p>
                                <label for="dropzone-file" className="flex flex-col items-center justify-center w-full h-42 border-2 border-gray-300 border-dashed rounded cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <div className='bg-gradient-to-r from-pink-100 via-pink-50 to-pink-50 mt-6 rounded-lg'>
                                ...
                                <div className='flex items-center justify-between p-4 '>
                                    ...
                                    <button onClick={handleCouponModal} type="button" class="flex items-center gap-2 text-white bg-blush-red font-medium rounded-lg text-sm px-5 py-3"><FaPlusCircle />
                                        Add</button>
                                </div>
                            </div>
                             
                            <div className="p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400 mt-4" role="alert">
                            <span className="font-medium">Website Message, Include Unsubscribe</span>
                            </div>
                            ...
                            <Modal open={addCoupon} handleOpen={handleCouponModal} size={"sm"}>
                                <div>
                                  <div className='bg-gradient-to-r from-pink-100 via-pink-50 to-pink-50 rounded-t-lg flex items-center justify-between p-4'>
                                    ...
                                    <input type="text" id="first_name" class="bg-gray-50 border  text-gray-900 text-sm rounded  block w-full p-2.5" placeholder="Enter Coupon Name" required />
                                    </div>

                                    
                                    <div className="mt-6 w-full">
                                    <p className="text-base font-semibold mb-2 text-black">Points/Percentages</p>
                                    <input type="text" id="first_name" class="bg-gray-50 border  text-gray-900 text-sm rounded  block w-full p-2.5" placeholder="Enter Points/Percentages" required />
                                    </div>

                                    <div className="mt-6 w-full">
                                    <p className="text-base font-semibold mb-2 text-black">Validity Period of the Coupon</p>
                                    <input type="date" id="first_name" class="bg-gray-50 border  text-gray-900 text-sm rounded  block w-full p-2.5" placeholder="02-05-2024" required />
                                    </div>

                                    <div className="mt-8 w-full">
                                <button type="button" class="text-white w-full bg-blush-red font-medium rounded-lg text-sm px-5 py-4 mb-2">Submit</button>
                                    </div>
                                       </form>
                                    </div>
                                </div>
                            ...
                            <div className="mt-8 w-full">
                                <button type="button" class="text-white w-full bg-blush-red font-medium rounded-lg text-md px-5 py-4 mb-2">Submit</button>
                            </div>
                        </form>
                    </div>
                </Container>
...
export default AddStoreBirthday