    ...
    <div>
            ...
            <div className=" mb-20">
              ...
              <h2 className=" text-center text-2xl font-semibold">
               ...
               <MmenuShopCafeCard data={MenushopCafeDummyData} handleView={handleMenuCafeViewModal} />
                </div>
                <div className="lg:col-span-2 mobile:col-span-1 sm:col-span-4 md-landscape:col-span-3 mb-16">
               <MmenuShopCafeCard data={MenushopCafeDummyData} handleView={handleMenuCafeViewModal} />
                </div>
               ...
               <MmenuShopCafeCard data={MenushopCafeDummyData} handleView={handleMenuCafeViewModal} />
                ...
                <Modal size={"sm"} handleOpen={handleMenuCafeViewModal} open={menuCafeViewModal}>
