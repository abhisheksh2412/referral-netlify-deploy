...
const CouponDummyData = {
    ...
    description: "Get 20% off on your next purchase with this exclusive summer offer. Valid until 31st July 2024. Terms and conditions apply."
  };
            ...
            <div className="py-16 mobile:py-6 mobile:p-4">
              ...
              View All Coupons
               ...
               <div className="grid grid-cols-12 gap-16 mobile:grid-cols-1  mobile:gap-16 sm:gap-12">
                ...
                <CouponsCard data={CouponDummyData} handleView={handleViewcoupon} />
                </div>
...
export default CustomerViewAllCoupon
