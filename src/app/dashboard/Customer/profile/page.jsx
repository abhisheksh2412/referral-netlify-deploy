    ...
    <Loader isLoading={isLoading}>
      <div>
        ...
        <div className="p-12 bg-gray-100">
          <Container>
            <div className="relative  rounded-lg w-1/2		mx-auto bg-white">
              <div className="px-8 ">
              ...
              <div className="flex justify-between mt-16 gap-5 bg-gray-50 p-3 px-5 mb-1 rounded">
              ...
              <div className="flex justify-between gap-5 bg-gray-50 p-3 px-5 mb-1 rounded">
                <div className="flex items-center gap-3">
                  <div className="text-base font-semibold flex items-center gap-2">
                    {" "}
