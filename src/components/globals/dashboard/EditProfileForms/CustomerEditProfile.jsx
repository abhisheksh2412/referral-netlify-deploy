...
import { GetUpdateProfileByCustomerId } from "@/store/slices/customer";
import Image from "next/image";
export default function CustomerEditProfile({ handleOpen }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      await dispatch(
        GetUpdateProfileByCustomerId({ userid: user?.id, data: formdata })
      );
