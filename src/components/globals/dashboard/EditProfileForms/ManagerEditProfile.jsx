...
import { UpdateProfileByManagerId } from "@/store/slices/manager";
import Image from "next/image";

export default function ManagerEditProfile({ handleOpen }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      await dispatch(UpdateProfileByManagerId(user?.id, formdata));
