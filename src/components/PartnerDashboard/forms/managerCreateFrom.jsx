...
export default function ManagerCreateFrom({ handleClose }) {
  ...
  useEffect(() => {
    if (manager.isSuccess && !hasShownPopup) {
      popup({
        status: "success",
  ...
  }, [manager.isSuccess, hasShownPopup, handleClose]);

  return (
    <Loader isLoading={manager.isLoading}>
      <div>
