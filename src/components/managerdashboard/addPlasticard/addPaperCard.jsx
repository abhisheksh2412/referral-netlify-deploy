...
function AddPaperCardForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      setPaperCardData(data);
      console.log(values);
      console.log(RemoveSpaces(user?.role));
      router.push(
        `/dashboard/${RemoveSpaces(user?.role)}/manageOthers/buyPaperCard`
      );
    },
  });
...
export default AddPaperCardForm;
