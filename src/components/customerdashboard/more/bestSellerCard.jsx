  ...
  return (
    <div>
      <div className="shadow bg-white rounded-lg p-0 relative pb-2 rounded-b-lg mb-4 group cursor-pointer">
        ...
        <div className="px-3">
          <h3 className="text-center font-semibold pt-3 mb-3">
            {data?.product?.name}
          </h3>
          <p className="text-sm line-clamp-2 h-[40px] text-center">
            {data?.description}
          </p>
          <h4 className="text-center p-1 font-medium text-neutral-400 rounded-full bg-pink-100 text-pink-800 px-6 py-0.5 table mx-auto my-2">
