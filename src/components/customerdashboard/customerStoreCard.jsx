            ...
            <div className="flex flex-col gap-2 p-4">
              ...
              <span className="flex flex-col">
                ...
                <p className="text-md font-normal text-gray-700">
                  ...
                  Quisquam enim eaque rerum beatae facilis quos totam ad ipsum
                  explicabo magnam distinctio recusandae debitis amet architecto
                  vero, dolore hic doloremque animi! Obcaecati error minus
                  aspernatur, saepe earum voluptas asperiores quasi, quia
                  repudiandae, sed architecto quos reprehenderit?
                </p>
              </span>
            </div>
